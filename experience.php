...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Qualification=:qualification,Experience=:experience,Department=:department where EmailId=:eid";
...
$query->execute();
$msg="Your Qualification updated Successfully";
}
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Update Faculty Qualification</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Faculty Qualification</div>
                    </div>
