                ...
                <nav class="cyan darken-1">
                    <div >
                        <section class="material-design-hamburger navigation-toggle">
                            <a href="index.php"  class="button-collapse show-on-large material-design-hamburger__icon">
                                <span class="material-design-hamburger__layer"></span>
                            </a>
                        </section>
                        <div class="header-title col s3">      
                            <span class="chapter-title">FLMS | Faculty Leave Management System</span>
                        </div>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="col s12 m6 l8 offset-l2 offset-m3"  style="margin-left:80px;">
                        <div class="card-title"  style=" font-size:20px; margin-top:80px;margin-left:200px; margin-right:100px; margin-bottom:-100px;"><h4>Faculty Password Recovery</h4></div>
                              <div class="card white darken-1" style="margin-left:100px; margin-right:100px;">

                                  <div class="card-content " style="margin-top:150px;">
...
foreach ($results as $result) {
 ...
 <div class="row">
          <span class="card-title" style="font-size:20px; margin-left: 2%;"><b>change your password</b> </span>                                     
